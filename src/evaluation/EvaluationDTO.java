...
public class EvaluationDTO {
	...
	public String getLetureScore() {
		return letureScore;
	}
	public void setLetureScore(String letureScore) {
		this.letureScore = letureScore;
	}
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			...
			String totalScore, String creditScore, String comfortableScore, String letureScore, int likeCount) {
		this.evaluationID = evaluationID;
		this.userID = userID;
		this.lectureName = lectureName;
		this.professorName = professorName;
